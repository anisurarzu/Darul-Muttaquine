          ...
          <div className="bg-white shadow-md rounded-md mr-2 ml-2 ml-auto mr-auto">
            ...
            <ul className="grid grid-cols-2 mt-5">
              <li className=" card-hard-text ml-auto mr-auto  text-center mt-1">
                <GiWorld
                  size={60}
                  className="icon-class1 icon text-center mr-5 animate-spin"></GiWorld>
              </li>
          ...
          <div className="bg-white shadow-md mr-2 ml-2 ml-auto mr-auto">
            ...
            <ul className="grid grid-cols-2 mt-5">
              <li className="  card-hard-text ml-auto mr-auto  text-center mt-1 ">
                <AiOutlineMail
                  size={60}
                  className="icon-class2 icon text-center mr-5 text-green-500"></AiOutlineMail>
              </li>
              <li className="text-xl ml-0 text-gray-500 mt-4 office-class">
                Office Address
              </li>
            ...
            <ul className="grid grid-cols-2 mt-5">
              <li className="  card-hard-text ml-auto mr-auto  text-center mt-1">
                <RiCustomerService2Fill
                  size={60}
                  className="icon-class3 icon text-center mr-5  "></RiCustomerService2Fill>
              </li>
              <li className="text-xl ml-0 text-gray-500 mt-4 office-class">
                Office Address
              </li>
