...
const PublicScholarship = ({ onHide, fetchRolls, handleCancel }) => {
  ...
  const instructions = [
    "পরীক্ষার সময় ১০০ মিনিট।",
    "পরীক্ষা সকাল ৯:০০ টায় শুরু হবে।",
    "অনুগ্রহ করে নির্ধারিত সময়ের আগে পরীক্ষার কেন্দ্রে উপস্থিত হন।",
    "প্রশ্নপত্রের প্রতিটি প্রশ্ন পড়ুন এবং উত্তর দেওয়ার আগে ভালোভাবে বুঝে নিন।",
    "যদি কোন প্রশ্নে ভুল উত্তর দেন, তাহলে অন্যান্য প্রশ্নে সঠিকভাবে মনোযোগ দিন।",
    "অতিবিলম্বে আপনার উত্তরপত্র জমা দিন পরীক্ষার শেষে।",
